...
type Documents = {
    ...
    "query GetStocks($search: String, $status: String, $limit: Int) {\n  stocks(search: $search, status: $status, limit: $limit) {\n    code\n    name\n    sector\n    market\n    analysisResults {\n      date\n      stockPrice\n      status\n      isGoodBuy\n      zScore\n      grossProfitability\n      impliedGrowthRate\n    }\n  }\n}": typeof types.GetStocksDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetStocks($search: String, $status: String, $limit: Int) {\n  stocks(search: $search, status: $status, limit: $limit) {\n    code\n    name\n    sector\n    market\n    analysisResults {\n      date\n      stockPrice\n      status\n      isGoodBuy\n      zScore\n      grossProfitability\n      impliedGrowthRate\n    }\n  }\n}"): (typeof documents)["query GetStocks($search: String, $status: String, $limit: Int) {\n  stocks(search: $search, status: $status, limit: $limit) {\n    code\n    name\n    sector\n    market\n    analysisResults {\n      date\n      stockPrice\n      status\n      isGoodBuy\n      zScore\n      grossProfitability\n      impliedGrowthRate\n    }\n  }\n}"];
